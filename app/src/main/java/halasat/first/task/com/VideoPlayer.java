...
public class VideoPlayer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mExoPlayerFullscreen) {
            mFullScreenIcon.setImageDrawable(ContextCompat.getDrawable(VideoPlayer.this, R.drawable.ic_fullscreen_shrink));
        }
            ...
            public void onClick(View view) {
                ...
                switch (integer) {
                    case R.drawable.ic_mobile_orientation:
                        imageView.setImageDrawable(ContextCompat.getDrawable(VideoPlayer.this, R.drawable.ic_lock_orientaion));
                        imageView.setTag(R.drawable.ic_lock_orientaion);
                        ...
                        break;
                    case R.drawable.ic_lock_orientaion:
                    default:
                        imageView.setImageDrawable(ContextCompat.getDrawable(VideoPlayer.this, R.drawable.ic_mobile_orientation));
    ...
    private void setOrientationSensor() {
        orientationEventListener = new OrientationEventListener(VideoPlayer.this) {
            @Override
            public void onOrientationChanged(int orientation) {
                ...
                if (epsilonCheck(orientation, leftLandscape, epsilon) ||
                    ...
                    VideoPlayer.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_SENSOR);
                }
            }
...
// Show status bar
    ...
    private void closeFullscreenDialog() {
        ...
        hideSystemUI();
        mFullScreenIcon.setImageDrawable(ContextCompat.getDrawable(VideoPlayer.this, R.drawable.ic_fullscreen_expend));
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
